  ...
  const links = [
    {
      ...
      icon: PillBottle,
      title: "Medicamentos",
      description: "Comienza a gestionar los medicamentos",
    },
    {
      href: "/obras-sociales",
      icon: Hospital,
      title: "Obra social",
      description: "Comienza a gestionar las obras sociales",
    },
    {
      href: "/guias-terapeuticas",
      icon: FileText,
      title: "Guías Terapéuticas",
      description: "Consulta las guías terapéuticas cargadas",
    },
    {
      href: "/adjuntos",
      icon: Files,
      title: "Adjuntos",
      description: "Consulta adjuntos",
    },
  ];
